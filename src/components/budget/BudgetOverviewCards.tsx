...
import { DollarSign, TrendingUp, TrendingDown, AlertTriangle, IndianRupee } from "lucide-react";
...
const BudgetOverviewCards = ({ totalBudget, totalSpent, netCashFlow,changePercent, pendingApprovals }: BudgetOverviewProps) => {
