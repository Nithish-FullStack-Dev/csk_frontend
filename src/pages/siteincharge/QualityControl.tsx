                          ...
                          <DropdownMenu>
                            ...
                            <DropdownMenuContent align="end">
                              ...
                              <DropdownMenuItem onClick={() => {
                                ...
                                }}>View Evidence</DropdownMenuItem>
                            </DropdownMenuContent>
                          </DropdownMenu>
                        </TableCell>
                      </TableRow>
      ...
      <DialogContent className="max-w-3xl w-full p-6 rounded-2xl shadow-xl transition-all duration-300">
        <DialogHeader>
          ...
          <DialogDescription className="text-sm text-muted-foreground">
            These are the photos submitted as evidence for the selected issue.
          </DialogDescription>
        </DialogHeader>
        ...
        <div className="mt-4">
          {selectedIssue && selectedIssue.evidenceImages.length > 0 ? (
            ...
            <div className="flex flex-col items-center justify-center py-12 text-center text-muted-foreground gap-2">
              ...
              <p className="text-lg font-medium">No evidence uploaded</p>
              <p className="text-sm">This issue has no images attached yet.</p>
            </div>
          )}
        </div>

        <DialogFooter className="pt-6">
          <Button onClick={() => setEvidenceDialogOpen(false)} variant="outline">
            Close
          </Button>
        </DialogFooter>
      </DialogContent>
