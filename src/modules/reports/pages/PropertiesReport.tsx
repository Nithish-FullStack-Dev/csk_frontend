...
export default function PropertiesReport() {
  ...
  const avgSellThrough = mockData.reduce((sum, row) => sum + row.sellThroughPercent, 0) / mockData.length;

  const metrics = [
    { label: "Total Revenue", value: totalRevenue, format: "currency" as const, trend: { value: 12.5, isPositive: true } },
    { label: "Total Bookings", value: totalBookings, format: "number" as const, trend: { value: 8.3, isPositive: true } },
    { label: "Units Sold", value: totalSold, format: "number" as const, trend: { value: 15.2, isPositive: true } },
    { label: "Avg Sell-Through", value: avgSellThrough, format: "percent" as const, trend: { value: 3.4, isPositive: true } },
  ];
